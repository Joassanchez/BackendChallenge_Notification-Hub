...
import type { ProviderConnectionWithProvider, ProviderRepository } from "./provider.repository.js";
...
export class ProviderService {
  ...
  async listProviderConnectionsForAdmin(): Promise<{ providerConnections: ProviderConnectionAdminDto[] }> {
    const connections = await this.providers.findProviderConnectionsForAdmin();
